...
class ScriptArguments:
    ...
    dataset_name: Optional[str] = field(
        default="amay01/llm-sgd-dst8-train-test-data",
    ...
    max_steps: int = field(default=40000, metadata={"help": "How many optimizer update steps to take"})
...
def create_and_prepare_model(args):
    ...
    peft_config = LoraConfig(
        ...
        bias="none",
        task_type="CAUSAL_LM",
        target_modules = ["q_proj", "v_proj"],  # , "word_embeddings", "lm_head"],
    )
...
model.save_pretrained("test-llama7b-sgd-dst-quant-4bit")

model.push_to_hub("amay01/test-llama7b-sgd-dst-quant-4bit")