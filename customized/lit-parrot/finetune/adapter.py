...
epoch_size = 200000  # train dataset size
num_epochs = 10
...
def setup(
    data_dir: Path = Path("data/dst/train"),
    checkpoint_dir: Path = Path("checkpoints/tiiuae/falcon-7b-instruct"),
    out_dir: Path = Path("out/dst/adapter/"),
...
def main(
    ...
    with lazy_load(checkpoint_path) as checkpoint:
        #adapter_checkpoint = torch.load("./out/dst/adapter/iter-239999.pth") # ++
