...
DATA_FILE_URL = "https://raw.githubusercontent.com/tloen/alpaca-lora/main/alpaca_data_cleaned_archive.json" # ignore
DATA_FILE_NAME = "./data/instruction_based_dst_train.json"
DESTINATION_PATH = Path("data/dst/train")
