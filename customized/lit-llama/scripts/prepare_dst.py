...
DATA_FILE = "https://raw.githubusercontent.com/tloen/alpaca-lora/main/alpaca_data_cleaned_archive.json" # ignore
DATA_FILE_NAME = "./data/instruction_based_dst_train.json"  # Insert custom dataset here 
IGNORE_INDEX = -1


def prepare(
    destination_path: Path = Path("data/dst/train"), #
