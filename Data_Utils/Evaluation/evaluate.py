...
def get_metrics(dataset_ref, dataset_hyp, service_schemas, in_domain_services):
  ...
  #with open('bert_hyp_dataset.pickle', 'wb') as f:
  #    pickle.dump(dataset_hyp, f)

  with open('./schema_guided_dst/bert_hyp_dataset_falcon_injected.pickle', 'rb') as f:
      llama_preds = pickle.load(f)

  dataset_hyp = llama_preds
